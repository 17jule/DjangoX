    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(blank=True, default='', max_length=64, null=True)),
        ...
        migrations.AddField(
            model_name='a',
            name='b',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.B', verbose_name='属主'),
        ),
    ]
